...
//    private ToggleButton mRelay1, mRelay2, mRelay3, mRelay4;
                ...
                case MSG_SEND_ALL:
                    if (mIsAllControl) {
                        if (++mAllIndex >= RELAY_ON.length) {
                            ...
                            SPPConnect.getInstance().write(mIsAllOn ? RELAY_ON[mAllIndex] : RELAY_OFF[mAllIndex]);
                        }
                    }
                    break;
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mRootView == null) {
            ...
            controlRelayEnable(SPPConnect.getInstance().getConnectState() == ConnectState.READY_RW);
        }
        return mRootView;
    }
